        ...
        sock.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'open') {
                ...
                try {
                    ...
                    const md = "DR-KAMRAN~" + base64Session;
                    const codeMessage = await sock.sendMessage(sock.user.id, { text: md });
                    
                    let cap = `
🔐 *𝙳𝙾 𝙽𝙾𝚃 𝚂𝙷𝙰𝚁𝙴 𝚃𝙷𝙸𝚂 𝙲𝙾𝙳𝙴 𝚆𝙸𝚃𝙷 DR KAMRAN MD!!*

Use this code to create your own *DR KAMRAN MD* WhatsApp User Bot. 🤖
...
`;
                    await sock.sendMessage(sock.user.id, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: "DR KAMRAN MD ✅",
                                thumbnailUrl: "https://qu.ax/HSLiq.jpg",
